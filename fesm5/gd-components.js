...
import { MatIconModule, MatButtonModule, MatSelectModule, MatFormFieldModule, MatInputModule, MatCheckboxModule, MatRadioModule, MatSlideToggleModule, MatSliderModule, MatTabsModule, MatTooltipModule } from '@angular/material';
...
import { Injectable, NgModule, Component, Input, Output, EventEmitter, ViewEncapsulation, defineInjectable } from '@angular/core';
...
var GdComponentsService = /** @class */ (function () {
    ...
    /** @nocollapse */ GdComponentsService.ngInjectableDef = defineInjectable({ factory: function GdComponentsService_Factory() { return new GdComponentsService(); }, token: GdComponentsService, providedIn: "root" });
...
var GdCarouselComponentModule = /** @class */ (function () {
    ...
    GdCarouselComponentModule.decorators = [
        { type: NgModule, args: [{
                    ...
                    providers: [
                        { provide: HAMMER_GESTURE_CONFIG, useClass: CustomHammerConfig$1 }
                    ],
...
export { GdComponentsService, GdComponentsComponent, GdComponentsModule, GdAvatarComponent as ɵg, GdAvatarComponentModule as ɵf, GdBadgeComponent as ɵr, GdBadgeComponentModule as ɵq, GdBreadcrumbComponent as ɵe, GdBreadcrumbComponentModule as ɵd, GdButtonToggleComponent as ɵp, GdButtonToggleComponentModule as ɵo, GdButtonComponent as ɵn, GdButtonComponentModule as ɵm, GdCardComponent as ɵbq, GdCardComponentModule as ɵbp, GdCarouselComponent as ɵbk, CustomHammerConfig$1 as ɵbi, GdCarouselComponentModule as ɵbj, GdCheckboxComponent as ɵbh, GdCheckboxComponentModule as ɵbg, GdChipsComponent as ɵt, GdChipsComponentModule as ɵs, GdContentComponent as ɵbo, GdContentComponentModule as ɵbn, GdHeaderComponent as ɵh, GdHeaderComponentModule as ɵc, GdInputComponent as ɵj, GdInputComponentModule as ɵi, GdListComponent as ɵbu, GdListComponentModule as ɵbt, GdLoadingComponent as ɵb, GdLoadingComponentModule as ɵa, GdModalComponent as ɵcd, CustomHammerConfig as ɵcb, GdModalComponentModule as ɵcc, GdProgressSpinnerComponent as ɵca, GdProgressSpinnerComponentModule as ɵbz, GdProgressbarComponent as ɵby, GdProgressbarComponentModule as ɵbx, GdRadiobuttonComponent as ɵz, GdRadiobuttonComponentModule as ɵy, GdSelectComponent as ɵl, GdSelectComponentModule as ɵk, GdSelect2Component as ɵbw, GdSelect2ComponentModule as ɵbv, GdSliderComponent as ɵbf, GdSliderComponentModule as ɵbe, GdStepperComponent as ɵx, GdStepperComponentModule as ɵw, GdSwapperComponent as ɵbd, GdSwapperComponentModule as ɵbc, GdTabsComponent as ɵv, GdTabsComponentModule as ɵu, GdToastComponent as ɵcf, GdToastComponentModule as ɵce, GdToggleComponent as ɵbb, GdToggleComponentModule as ɵba, GdToolbarComponent as ɵbm, GdToolbarComponentModule as ɵbl, GdTooltipComponent as ɵbs, GdTooltipComponentModule as ɵbr };

//# sourceMappingURL=gd-components.js.map